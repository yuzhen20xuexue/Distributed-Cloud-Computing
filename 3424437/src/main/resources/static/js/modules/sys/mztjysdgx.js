$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sysZsjh/mztjysdgxlist',
        datatype: "json",
        colModel: [
            ...
            {label: '批次', name: 'stpc', index: "syd", width: 100},
            {label: '选科要求', name: 'stxkyq', index: "syd", width: 100},
            {label: '最低分', name: 'stzdf', index: "syd", width: 100},
            {label: '最低分排名', name: 'stzdfpm', index: "syd", width: 100},
            {label: '省控线', name: 'stskx', index: "syd", width: 100},
            {label: '软科排名', name: 'rkpmpm', index: "syd", width: 100},
            {label: '学校名次', name: 'xyhdxpmxxmc', index: "syd", width: 100},
            {label: '总分', name: 'xyhdxpmzf', index: "syd", width: 100},
            {label: '星级', name: 'xyhdxpmxj', index: "syd", width: 100},
            {label: '办学层次', name: 'xyhdxpmbxcc', index: "syd", width: 100},
