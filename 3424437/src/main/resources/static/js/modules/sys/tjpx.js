$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sysTdx/tjpxlist',
        datatype: "json",
        colModel: [
            {label: 'ID', name: 'id', index: "id", width: 45, key: true},
            {label: '学校', name: 'xuexiao', index: "xuexiao", width: 100},
            {label: '推荐排序', name: 'xuhao', index: "zslx", width: 100},
            {label: '最低分', name: 'zdf', index: "zslx", width: 100},
            {label: '省控线', name: 'skx', index: "zslx", width: 100},
    ...
    methods: {
        ...
        reload: function () {
            ...
            $("#jqGrid").jqGrid('setGridParam', {
                postData: {'name': vm.q.tdxName,'klName': vm.q.klName,'zdfName': vm.q.zdfName},
