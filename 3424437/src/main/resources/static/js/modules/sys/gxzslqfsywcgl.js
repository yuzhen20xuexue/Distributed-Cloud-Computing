$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sysTdx/gxzslqfsywcgllist',
        datatype: "json",
        colModel: [
            ...
            {label: '一份一段分数', name: 'yfydfs', index: "syd", width: 100},
            {label: '一份一段本段人数', name: 'yfydbdrs', index: "syd", width: 100},
            {label: '一份一段累计人数', name: 'yfydjrs', index: "syd", width: 100},
    ...
    methods: {
        ...
        reload: function () {
            ...
            $("#jqGrid").jqGrid('setGridParam', {
                postData: {'name': vm.q.tdxName,'zyName': vm.q.zyName,'xuexiaoName': vm.q.xuexiaoName},
                page: page
            }).trigger("reloadGrid");
        },
