$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '软科排名', name: 'srpm', index: "srpm", width: 100},
            ...
            { label: '是否双一流', name: 'issyl', width: 80,
                formatter: function(value, options, row){
                    if(value === "是"){
                        return '<span class="label label-success">是</span>';
                    }else if(value === "否"){
        ...
        onSortCol: function (index, columnIndex, sortOrder) {
            ...
            $("#jqGrid").jqGrid("setGridParam",{
                url: baseURL + 'sysTdx/zyjscollist',
                datatype: "json",
...
var vm = new Vue({
    ...
    methods: {
        ...
        reload: function () {
            ...
            $("#jqGrid").jqGrid('setGridParam', {
                postData: {'name': vm.q.tdxName,'xxname':vm.q.xxName},
                page: page
            }).trigger("reloadGrid");
        },
